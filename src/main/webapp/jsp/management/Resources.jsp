...
<%@ page import="com.xmbl.ops.enumeration.EnumMenuType" %>
		...
		<table class="table table-hover table-bordered table-condensed mt8">
			...
			<tbody class="ui-fold-table" id="menu-list">
				<c:forEach var="resource" items="${ resourcesList }">
					<tr class="ui-row-${ resource.level } unfold" data-id="${ resource.id }" data-index="${ resource.levelTree }" data-name="${ resource.name }" data-sign="${ resource.reskey }" data-link="${ resource.resurl }" data-type="${ resource.type }" data-status="${ resource.status }" data-description="${ resource.description }">
						<td>
