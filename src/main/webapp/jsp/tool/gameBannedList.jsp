...
<body>
<c:set var="preUrl" value="gameBannedInfoList
	...
	<header class="ui-page-header">
		<div class="mini-title">当前位置：禁言|封号列表管理</div>
	</header>
		...
		<table class="table table-hover table-bordered table-condensed">
			<thead>
				<tr class="info">
					...
					<th class="min-w80">玩家id</th>
					<th class="min-w50">玩家昵称</th>
					<th class="min-w50">操作类型</th>
