...
<html lang="zh-CN">
	...
	<body>
		...
		<article class="container-fluid">
			...
			<div class="panel panel-default">
				<div class="panel-heading ui-flex-between"><span>用户数据明细</span><a id="btn-export" href="<%=basePath%>generateDayRemain/exportDayNewLogin?startDate=${startDate}&endDate=${endDate}&type=1" class="btn btn-success btn-xs">导出</a></div>
				<div class="panel-body">
				...
				success: function() {
					seajs.use(['lib/jquery', 'lib/highcharts', 'util/bootstrap.datetimepicker.zh-CN', 'util/ajaxPromise', 'util/artTemplate'], function($, highcharts, datetimepicker, ajaxPromise, tmpl) {
						...
						updateData = function() {
							...
							ajaxPromise({
								url: window.basePath + 'generateDayRemain/daDayNewLoginSearch',
								type: 'GET',
								data: config,
								dataType: 'json'
							}).then(function(data) {
