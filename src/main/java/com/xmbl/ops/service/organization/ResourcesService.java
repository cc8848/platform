...
public class ResourcesService {
    ...
    private List<Resources> directoryFilter(List<Resources> resourcesList) {
        ...
        for(Resources resource: resourcesList) {
        	if (resource.getType() == EnumMenuType.PATH.getId()) {
    ...
    public void commitEdit(String userKey, Integer id, String name, String resUrl, String resKey,
    	...
    	Resources resource = new Resources(userKey, id, name, resUrl, resKey, parentId, status, pid, type, level, description);
    	if(id != null) {
